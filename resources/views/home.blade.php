...
<<<<<<< HEAD
    ...
    <section id="footer">
            ...
            <div class="contentt">
                <div class="left-side">
                    <div class="address details">
                        ...
                        <div class="text-one">Cité Technologique des Communications Rte de Raoued Km 3,5 - 2083, Ariana
                            Tunisie</div>
                    </div>
                ...
                <div class="right-side">
                    ...
                    <p class="par11">Your privacy is a priority for us. Discover how we handle your information
                        responsibly by reviewing our Privacy Policy. We are committed to transparency and safeguarding
                        your data throughout your interaction with our services.</p>
                    <div class="topic-text">Join Our Newsletter Now </div>
                    <p class="par11">Enjoy our newsletter to stay updated with the latest news and special sales. Lets
                        your email address here!</p>
                    <form action="#">
                        <div class="input-box">
        ...
        <div class="last">
            <div class="social"><a href="https://www.instagram.com/junior_supcom/"><i
                        class="fa-brands fa-instagram"></i></a><a
                    href="https://www.linkedin.com/company/supcomjuniorentreprise/?trk=public_profile_experience-item_profile-section-card_subtitle-click&originalSubdomain=fr"><i
                        class="fa-brands fa-linkedin"></i></a><a
                    href="https://www.facebook.com/SupComJuniorEntrepriseSJE"><i class="fa-brands fa-facebook"></i></a>
            </div>
