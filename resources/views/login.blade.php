          ...
          <x-auth-session-status class="mb-4" :status="session('status')" />
            ...
            <form class="login-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group"> 
                    ...
                    <x-input id="email" class="loginEmail" type="email" name="email" :value="old('email')"  autofocus autocomplete="username" />
                    <span class="error"></span>
                ...
                <div class="form-group">
                    ...
                    <x-input id="password" class="loginPassword" type="password" name="password" autocomplete="current-password" />
                    <span class="toggle-password"><i class="fas fa-eye-slash"></i></span>
                    <span class="error"style="display: inline;max-width: 336px;height: 1.5vh;"></span>
                </div>
                ...
                <div class="block mt-4"style="margin-top: 4vh;margin-block-end: -2vh;">
                    <label for="remember_me" class="flex items-center">
                        ...
                        <x-checkbox id="remember_me" name="remember" style="margin-inline-start: -21vh;margin-block-start: -1.8vh;"/>
                    </label>
                </div>
